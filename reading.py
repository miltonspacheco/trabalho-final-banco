...
updates['Assinatura'] = sql_read[5].strip()  
updates['Album'] = sql_read[6].strip()  
...
deletes['Podcast_Tema'] = sql_read[0].strip()
deletes['Tema'] = sql_read[1].strip()
deletes['Podcast'] = sql_read[2].strip()
deletes['Podcaster'] = sql_read[3].strip()
deletes['Genero_Musica'] = sql_read[4].strip()
deletes['Genero'] = sql_read[5].strip()
deletes['Musica'] = sql_read[6].strip()
deletes['Midia_Playlist'] = sql_read[7].strip()
deletes['Reproducao'] = sql_read[8].strip()
deletes['Midia'] = sql_read[9].strip()  
deletes['Album'] = sql_read[10].strip()  
deletes['Artista'] = sql_read[11].strip()  
deletes['Playlist'] = sql_read[12].strip()  
deletes['Assinatura'] = sql_read[13].strip()  
deletes['Usuario'] = sql_read[14].strip() 
deletes['Plano_Assinatura'] = sql_read[15].strip()
